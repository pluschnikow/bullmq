...
class Queue extends _1.QueueGetters {
    ...
    async add(jobName, data, opts) {
        if (opts && opts.repeat) {
            return (await this.repeat).addNextRepeatableJob(jobName, data, Object.assign(Object.assign({}, this.jobsOpts), opts), true);
        }
        else {
            const job = await _1.Job.create(this, jobName, data, Object.assign(Object.assign({}, this.jobsOpts), opts));
