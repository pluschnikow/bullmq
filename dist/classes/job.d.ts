...
export declare class Job {
    ...
    private toKey;
    private discarded;
    constructor(queue: QueueBase, name: string, data: any, opts?: JobsOptions, id?: string);
    static create(queue: QueueBase, name: string, data: any, opts?: JobsOptions): Promise<Job>;
    static createBulk(queue: QueueBase, jobs: {
        name: string;
        data: any;
        opts?: JobsOptions;
    }[]): Promise<Job[]>;
    static fromJSON(queue: QueueBase, json: any, jobId?: string): Job;
     ...
     */
    moveToCompleted(returnValue: any, token: string, fetchNext?: boolean): Promise<[JobJson, string] | []>;
    /**
